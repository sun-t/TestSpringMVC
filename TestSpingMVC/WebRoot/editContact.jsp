    ...
    <td align="center">
         <form:form action="updateContact.do" method="post" commandName="editContact" id="mainForm">
                <table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">                    
                    ...
                    <tr>
                        <td width="100" align="right">DateBegin</td>                 
                        <td><form:input path="dateBegin"/></td>
                        <td align="left"><form:errors path="dateBegin" cssStyle="color:red"></form:errors>  </td>                       
                   </tr>
                    
                    <tr>
                        <td width="100" align="right">DateEnd</td>
                        <td><form:input path="dateEnd"/></td>
                        <td align="left"><form:errors path="dateEnd" cssStyle="color:red"></form:errors>  </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td align="left">
                        <form:errors path="time" cssStyle="color:red"></form:errors>  </td>
                    </tr>
